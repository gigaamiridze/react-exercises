...
function BootstrapCard() {
  return (
    <div className='card' style={{ width: '20rem' }}>
      <img className='card-img-top' src={dylanImg} alt="Card image cap" />
      <div className='card-body'>
        ...
        <a href="https://en.wikipedia.org/wiki/Bob_Dylan" target="_blank" className='btn btn-primary'>Go to wikipedia</a>
      </div>
    </div>
  );
}
